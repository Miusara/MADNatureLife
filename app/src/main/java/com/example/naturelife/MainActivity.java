    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Email = edtEmailU.getText().toString().trim();
                String NIC = edtnicU.getText().toString().trim();
                String Password =edtpassU.getText().toString().trim();
                String REPassword =edtrpassU.getText().toString().trim();
                DatabaseReference ref = database.getReference("user");
                User user = new User(name,address,Email,NIC,Password,REPassword);
